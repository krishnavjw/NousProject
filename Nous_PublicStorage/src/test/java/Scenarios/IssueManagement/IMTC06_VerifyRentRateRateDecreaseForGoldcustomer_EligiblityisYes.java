...
public class IMTC06_VerifyRentRateRateDecreaseForGoldcustomer_EligiblityisYes extends Browser_Factory{
	...
	{
		return Excel.getCellValue_inlist(path, "IssueManagement","IssueManagement","VerifyRentRateRateDecreaseForGoldcustomer_EligiblityisYes");
	}
	@Test(dataProvider="getCustSearchData")
	public void VerifyRentRateRateDecreaseForGoldcustomer_EligiblityisYes(Hashtable<String, String> tabledata) throws InterruptedException 
	{
		try{
			logger=extent.startTest("VerifyRentRateRateDecreaseForGoldcustomer_EligiblityisYes", "VerifyRentRateRateDecreaseForGoldcustomer_EligiblityisYes");
			 ...
			 */
			/*
			 * Select "rent rate decerase" in issue type MW & click on confirm
			 */
			/*
			 * On the create rent rate decerase request issue screen,select any reason from the drop down list
			 */
			/*
...
/*			Verify the task is created for Div.M to approve
			...
			Verify the decreased rent is applied to the space from next month starting */
	...
	public void afterMethod(){
		...
		if(resultFlag.equals("pass")){
			Excel.setCellValBasedOnTcname(path, "IssueManagement","VerifyRentRateRateDecreaseForGoldcustomer_EligiblityisYes" , "Status", "Pass");
		}else if (resultFlag.equals("fail")){
			Excel.setCellValBasedOnTcname(path, "IssueManagement","VerifyRentRateRateDecreaseForGoldcustomer_EligiblityisYes" , "Status", "Fail");
		}else{
			Excel.setCellValBasedOnTcname(path, "IssueManagement","VerifyRentRateRateDecreaseForGoldcustomer_EligiblityisYes" , "Status", "Skip");
		}
