...
public class CustomerSearch_AdvancedSearchUsingLocationNoByEmail_CurrentlyRenting extends Browser_Factory {
	...
	public void CustomerSearch_AdvancedSearchUsingLocationNoByEmail(Hashtable<String, String> tabledata) throws Exception 
	{
