...
public class CustomerSearch_AdvancedSearchUsingLocationNoBySpaceNo_CurrentlyRenting extends Browser_Factory {
	...
	public void CustomerSearch_AdvancedSearchUsingLocationNoBySpaceNo(Hashtable<String, String> tabledata) throws Exception 
	{
