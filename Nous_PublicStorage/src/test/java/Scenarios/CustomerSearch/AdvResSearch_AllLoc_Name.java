...
public class AdvResSearch_AllLoc_Name extends Browser_Factory {
	...
	public void AdvanceSearchReservation_AllLoc_Name(Hashtable<String, String> tabledata) throws InterruptedException 
	{
		...
		try{
			...
			logger=extent.startTest(this.getClass().getSimpleName(),"Advance Search for a reservation using Name - Same Location");
			...
			/*String sqlQuery = "select top 1 r.lastname, r.firstname, p.phonenumber, e.email, r.reservationid"+
							...
							" where r.firstname like '"+tabledata.get("FirstName")+"%'"+
							" and t.name<> 'rented'"+
			...
			logger.log(LogStatus.INFO, "Name Search for an Invalid reservation");
			advRes.click_Reset();
			Thread.sleep(15000);
