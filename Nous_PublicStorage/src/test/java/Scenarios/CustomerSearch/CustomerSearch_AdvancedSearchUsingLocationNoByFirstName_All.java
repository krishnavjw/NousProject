...
public class CustomerSearch_AdvancedSearchUsingLocationNoByFirstName_All extends Browser_Factory {
	...
	{
		return Excel.getCellValue_inlist(path, "CustomerSearch","CustomerSearch","CustomerSearch_AdvancedSearchUsingLocationNoByFirstName_All");
	}


	@Test(dataProvider="getCustomerSearchData")	
	public void CustomerSearch_AdvancedSearchUsingLocationNoByFirstName(Hashtable<String, String> tabledata) throws Exception 
	{
		...
		try{
			logger=extent.startTest("CustomerSearch_AdvancedSearchUsingLocationNoByFirstName_All","Verifying the page with account number");
			...
			String SQlQuery = "select  DISTINCT a.accountnumber, a.accountnumber, c.firstname, c.lastname from contact c with (nolock) "+
					...
					"where  "+
					" c.firstname like '"+tabledata.get("FirstName")+"%' and s.sitenumber='"+location+"' order by c.lastname";
			...
			String SQLQueryCnt = "select count(DISTINCT a.accountnumber) from contact c with (nolock) " + 
					...
					"left join emailaddress ea with (nolock) on ea.emailaddressid=ae.emailid "+
					"where  "+
					" c.firstname like '"+tabledata.get("FirstName")+"%' and s.sitenumber='"+location+"'";
	...
	public void afterMethod(){
		...
		if(resultFlag.equals("pass")){
			Excel.setCellValBasedOnTcname(path, "CustomerSearch","CustomerSearch_AdvancedSearchUsingLocationNoByFirstName_All" , "Status", "Pass");

		}else if (resultFlag.equals("fail")){

			Excel.setCellValBasedOnTcname(path, "CustomerSearch","CustomerSearch_AdvancedSearchUsingLocationNoByFirstName_All" , "Status", "Fail");
		}else{
			Excel.setCellValBasedOnTcname(path, "CustomerSearch","CustomerSearch_AdvancedSearchUsingLocationNoByFirstName_All" , "Status", "Skip");
		}
