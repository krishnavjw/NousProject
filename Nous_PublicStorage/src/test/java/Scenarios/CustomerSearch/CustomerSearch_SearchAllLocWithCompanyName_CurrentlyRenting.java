...
public class CustomerSearch_SearchAllLocWithCompanyName_CurrentlyRenting extends Browser_Factory {
	...
	public void CustomerSearch_SearchAllLocWithCompanyName_CurrRenting(Hashtable<String, String> tabledata) throws InterruptedException 
	{

		if(!(tabledata.get("Runmode").equals("Y") && tabledata.get("CustomerSearch").equals("Y")))
		{
			resultFlag="skip";
			throw new SkipException("Skipping the CustomerSearch_SearchAllLocWithCompanyName_CurrRenting test");
		}

		try{

			logger=extent.startTest(this.getClass().getSimpleName(), "customer search in all location using currently renting  customer company name ");
			Thread.sleep(5000);
