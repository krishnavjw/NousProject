...
public class CustomerSearch_AdvancedSearchUsingLocationNoByLastName_FormerCust extends Browser_Factory {
	...
	{
		return Excel.getCellValue_inlist(path, "CustomerSearch","CustomerSearch","CustomerSearch_AdvancedSearchUsingLocationNoByLastName_FormerCust");
	}


	@Test(dataProvider="getCustomerSearchData")	
	public void CustomerSearch_AdvancedSearchUsingLocationNoByLastName(Hashtable<String, String> tabledata) throws Exception 
	{
		...
		try{
			logger=extent.startTest("CustomerSearch_AdvancedSearchUsingLocationNoByLastName_FormerCust","Verifying the page with account number");
			...
			String SQLQuery = "select DISTINCT a.accountnumber, a.accountnumber, c.lastname from contact c with (nolock) "+ 
					...
					"and c.lastname like '"+tabledata.get("LastName")+"%' and s.sitenumber='"+location+"' order by c.lastname";
			...
			String SQLQueryCnt = "select count(DISTINCT a.accountnumber) from contact c with (nolock) " + 
					...
					"left join emailaddress ea with (nolock) on ea.emailaddressid=ae.emailid "+
					"where soi.vacatedate is not null "+
					"and c.lastname like '"+tabledata.get("LastName")+"%' and s.sitenumber='"+location+"'";
	...
	public void afterMethod(){
		...
		if(resultFlag.equals("pass")){
			Excel.setCellValBasedOnTcname(path, "CustomerSearch","CustomerSearch_AdvancedSearchUsingLocationNoByLastName_FormerCust" , "Status", "Pass");

		}else if (resultFlag.equals("fail")){

			Excel.setCellValBasedOnTcname(path, "CustomerSearch","CustomerSearch_AdvancedSearchUsingLocationNoByLastName_FormerCust" , "Status", "Fail");
		}else{
			Excel.setCellValBasedOnTcname(path, "CustomerSearch","CustomerSearch_AdvancedSearchUsingLocationNoByLastName_FormerCust" , "Status", "Skip");
		}
