...
public class AdvancedSearchUsingState_CompanyName_All extends Browser_Factory {
	...
	{
		return Excel.getCellValue_inlist(path, "CustomerSearch","CustomerSearch","AdvancedSearchUsingState_CompanyName_All");
	}
	...
	public void AdvancedSearchUsingState_FirstName(Hashtable<String, String> tabledata) throws Exception 
	{
		...
		try{
			logger=extent.startTest("AdvancedSearchUsingState_CompanyName_All","Verifying the page with account number");
			...
			if(statusValue.equals(tabledata.get("StatusValue"))){
	...
	public void afterMethod(){
		...
		if(resultFlag.equals("pass")){
			Excel.setCellValBasedOnTcname(path, "CustomerSearch","AdvancedSearchUsingState_CompanyName_All" , "Status", "Pass");

		}else if (resultFlag.equals("fail")){

			Excel.setCellValBasedOnTcname(path, "CustomerSearch","AdvancedSearchUsingState_CompanyName_All" , "Status", "Fail");
		}else{
			Excel.setCellValBasedOnTcname(path, "CustomerSearch","AdvancedSearchUsingState_CompanyName_All" , "Status", "Skip");
		}
