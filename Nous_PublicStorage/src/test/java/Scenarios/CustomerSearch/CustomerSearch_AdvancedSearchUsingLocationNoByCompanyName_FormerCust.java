...
public class CustomerSearch_AdvancedSearchUsingLocationNoByCompanyName_FormerCust extends Browser_Factory {
	...
	public void CustomerSearch_AdvancedSearchUsingLocationNoByCompanyName_formerCust(Hashtable<String, String> tabledata) throws Exception 
	{
		...
		try{
			logger=extent.startTest(this.getClass().getSimpleName(),"Advance Search using Location Num by Company Name - Former Customer");
