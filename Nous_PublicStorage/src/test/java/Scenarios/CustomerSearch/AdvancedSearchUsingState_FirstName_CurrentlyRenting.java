...
public class AdvancedSearchUsingState_FirstName_CurrentlyRenting extends Browser_Factory {
	...
	{
		return Excel.getCellValue_inlist(path, "CustomerSearch","CustomerSearch","AdvancedSearchUsingState_FirstName_CurrentlyRenting");
	}
	...
	public void AdvancedSearchUsingState_FirstName(Hashtable<String, String> tabledata) throws Exception 
	{
		...
		logger=extent.startTest("AdvancedSearchUsingState_FirstName_CurrentlyRenting","Verifying the page with account number");
		...
		try{
	       ...
	       element.click();
			...
			Thread.sleep(3000);
			//driver.findElement(By.xpath("(//ul[@id='SearchContract_StateCode_listbox'])[2]/li[12]")).click();
			JavascriptExecutor je = (JavascriptExecutor) driver;
			Thread.sleep(2000);
	...
	public void afterMethod(){
		...
		if(resultFlag.equals("pass")){
			Excel.setCellValBasedOnTcname(path, "CustomerSearch","AdvancedSearchUsingState_FirstName_CurrentlyRenting" , "Status", "Pass");

		}else if (resultFlag.equals("fail")){

			Excel.setCellValBasedOnTcname(path, "CustomerSearch","AdvancedSearchUsingState_FirstName_CurrentlyRenting" , "Status", "Fail");
		}else{
			Excel.setCellValBasedOnTcname(path, "CustomerSearch","AdvancedSearchUsingState_FirstName_CurrentlyRenting" , "Status", "Skip");
		}
