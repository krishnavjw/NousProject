...
public class CustomerSearch_AdvancedSearchUsingLocationNoByEmail_All extends Browser_Factory {
	...
	public void CustomerSearch_AdvancedSearchUsingLocationNoByEmail_All(Hashtable<String, String> tabledata) throws Exception 
	{
		...
		try{
			logger=extent.startTest(this.getClass().getSimpleName(),"Advance Search using Location Num by Email -- All");
