...
public class CustomerSearch_AdvancedSearchUsingLocationNoByPhoneNo_CurrentlyRenting extends Browser_Factory {
	...
	public void CustomerSearch_AdvancedSearchUsingLocationNoByPhoneNo(Hashtable<String, String> tabledata) throws Exception 
	{
		...
		try{
			logger=extent.startTest(this.getClass().getSimpleName(),"Verifying the page with account number");
