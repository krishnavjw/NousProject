...
public class WalkINReservation_NewCustFindSpaceUsingSizeEstimatorInStandardStroage extends Browser_Factory {
	...
	{
		return Excel.getCellValue_inlist(path, "Reservation","Reservation","WalkINReservation_NewCustFindSpaceUsingSizeEstimatorInStandardStroage");
	}

	@Test(dataProvider="getResvnData")
	public void WalkINReservation_NewCustFindSpaceUsingSizeEstimatorInStandardStroage(Hashtable<String, String> tabledata) throws Exception 
	{
		...
		{
			resultFlag="skip";
			throw new SkipException("Skipping the WalkINReservation_NewCustFindSpaceUsingSizeEstimatorInStandardStroage test");
		}
		...
		try{
			...
			logger=extent.startTest("WalkINReservation_NewCustFindSpaceUsingSizeEstimatorInStandardStroage", "Find space using size, size estimator and space number - in standard storoge for new customer");
			...
			e.getMessage();
			resultFlag="fail";
			Reporter.log("Exception: WalkINReservation_NewCustFindSpaceUsingSizeEstimatorInStandardStroage"+e,true);
		}
	...
	public void afterMethod(){
		...
		if(resultFlag.equals("pass")){
			Excel.setCellValBasedOnTcname(path, "Reservation","WalkINReservation_NewCustFindSpaceUsingSizeEstimatorInStandardStroage", "Status", "Pass");

		}else if (resultFlag.equals("fail")){

			Excel.setCellValBasedOnTcname(path, "Reservation","WalkINReservation_NewCustFindSpaceUsingSizeEstimatorInStandardStroage", "Status", "Fail");
		}else{
			Excel.setCellValBasedOnTcname(path, "Reservation","WalkINReservation_NewCustFindSpaceUsingSizeEstimatorInStandardStroage", "Status", "Skip");
		}
