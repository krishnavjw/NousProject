...
public class UnenrollAutopay_Individual_Creditcard extends Browser_Factory{
	...
	public Object[][] getLoginData() 
	{
		...
		return Excel.getCellValue_inlist(path, "AutoPay","AutoPay", "UnenrollAutopay_Individual_Creditcard");
	}


	@Test(dataProvider="getLoginData")
	public void UnenrollAutopay_Individual_Creditcard(Hashtable<String, String> tabledata) throws InterruptedException
	{
		logger=extent.startTest("UnenrollAutopay_Individual_Creditcard","UnEnroll/stop/cancel Autopay for an Individual customer ");

		if(!(tabledata.get("Runmode").equals("Y") && tabledata.get("AutoPay").equals("Y")))
		{
			resultFlag="skip";
			logger.log(LogStatus.SKIP, "UnenrollAutopay_Individual_Creditcard is Skipped");
	...
	public void afterMethod(){
		...
		if(resultFlag.equals("pass")){
			Excel.setCellValBasedOnTcname(path,"AutoPay","UnenrollAutopay_Individual_Creditcard" , "Status", "Pass");

		}else if (resultFlag.equals("fail")){    
			Excel.setCellValBasedOnTcname(path,"AutoPay","UnenrollAutopay_Individual_Creditcard" , "Status", "Fail");
		}else{
			Excel.setCellValBasedOnTcname(path, "AutoPay","UnenrollAutopay_Individual_Creditcard" , "Status", "Skip");
		}
