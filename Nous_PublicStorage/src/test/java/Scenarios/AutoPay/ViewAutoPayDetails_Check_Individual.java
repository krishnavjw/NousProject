...
public class ViewAutoPayDetails_Check_Individual extends Browser_Factory{
	...
	{
		return Excel.getCellValue_inlist(path, "AutoPay","AutoPay","ViewAutoPayDetails_Check_Individual");
	}


	@Test(dataProvider="getAutopayCheck")	
	public void ViewAutoPayDetails_Check_Individual(Hashtable<String, String> tabledata) throws Exception 
	{
		...
		try{
			logger=extent.startTest("ViewAutoPayDetails_Check_Individual","Autopay individual customer with check");
...
*/
	...
	public void afterMethod(){
		...
		if(resultFlag.equals("pass")){
			Excel.setCellValBasedOnTcname(path, "AutoPay","ViewAutoPayDetails_Check_Individual" , "Status", "Pass");

		}else if (resultFlag.equals("fail")){

			Excel.setCellValBasedOnTcname(path, "AutoPay","ViewAutoPayDetails_Check_Individual" , "Status", "Fail");
		}else{
			Excel.setCellValBasedOnTcname(path, "AutoPay","ViewAutoPayDetails_Check_Individual" , "Status", "Skip");
		}
