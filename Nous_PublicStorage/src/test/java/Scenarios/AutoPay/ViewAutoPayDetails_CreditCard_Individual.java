...
public class ViewAutoPayDetails_CreditCard_Individual extends  Browser_Factory{
	...
	public Object[][] getAutopayCheck() 
	{
		...
		return Excel.getCellValue_inlist(path, "AutoPay","AutoPay", "ViewAutoPayDetails_CreditCard_Individual");
	}


	@Test(dataProvider="getAutopayCheck")
	public void ViewAutoPayDetails_CreditCard_Individual(Hashtable<String, String> tabledata) throws InterruptedException
	{
		logger=extent.startTest("ViewAutoPayDetails_CreditCard_Individual","View Autopay details");

		if(!(tabledata.get("Runmode").equals("Y") && tabledata.get("AutoPay").equals("Y")))
		{
			resultFlag="skip";
			logger.log(LogStatus.SKIP, "ViewAutoPayDetails_CreditCard_Individual is Skipped");
	...
	public void afterMethod(){
		...
		if(resultFlag.equals("pass")){
			Excel.setCellValBasedOnTcname(path,"AutoPay","ViewAutoPayDetails_CreditCard_Individual" , "Status", "Pass");

		}else if (resultFlag.equals("fail")){    

			Excel.setCellValBasedOnTcname(path,"AutoPay","ViewAutoPayDetails_CreditCard_Individual" , "Status", "Fail");
		}else{
			Excel.setCellValBasedOnTcname(path, "AutoPay","ViewAutoPayDetails_CreditCard_Individual" , "Status", "Skip");
		}
