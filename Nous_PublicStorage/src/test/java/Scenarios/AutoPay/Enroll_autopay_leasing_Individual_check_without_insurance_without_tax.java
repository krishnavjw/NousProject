...
public class Enroll_autopay_leasing_Individual_check_without_insurance_without_tax extends Browser_Factory{
	...
	public Object[][] getLoginData() 
	{
		...
		return Excel.getCellValue_inlist(path, "AutoPay","AutoPay", "Enroll_autopay_leasing_Individual_check_without_insurance_without_tax");
	}


	@Test(dataProvider="getLoginData")
	public void Enroll_autopay_leasing_Individual_check_without_ins_without_tax(Hashtable<String, String> tabledata) throws InterruptedException
	{

		if(!(tabledata.get("Runmode").equals("Y") && tabledata.get("AutoPay").equals("Y")))
		{
			resultFlag="skip";
			logger.log(LogStatus.SKIP, "Enroll_autopay_leasing_Individual_check_without_insurance_without_tax is Skipped");
		...
		try
		{
			...
			logger=extent.startTest("Enroll_autopay_leasing_Individual_check_without_insurance_without_tax","Enroll Into Autopay Thru Leasing _Individual_WithInsurance_WithoutTax_Check");
...
*/
		...
		/*	robot.keyPress(KeyEvent.VK_CONTROL);
			...
			logger.log(LogStatus.INFO, "Account Number Acreated : "+accNUm);
			scpath=Generic_Class.takeScreenShotPath();
			image=logger.addScreenCapture(scpath);
	...
	public void afterMethod(){
		...
		if(resultFlag.equals("pass")){
			Excel.setCellValBasedOnTcname(path, "AutoPay","Enroll_autopay_leasing_Individual_check_without_insurance_without_tax" , "Status", "Pass");

		}else if (resultFlag.equals("fail")){

			Excel.setCellValBasedOnTcname(path, "AutoPay","Enroll_autopay_leasing_Individual_check_without_insurance_without_tax" , "Status", "Fail");
		}else{
			Excel.setCellValBasedOnTcname(path, "AutoPay","Enroll_autopay_leasing_Individual_check_without_insurance_without_tax" , "Status", "Skip");
		}
