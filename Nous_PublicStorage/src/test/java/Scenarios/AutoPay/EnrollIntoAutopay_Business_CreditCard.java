...
public class EnrollIntoAutopay_Business_CreditCard extends Browser_Factory {
	...
	public Object[][] getLoginData() 
	{
		...
		return Excel.getCellValue_inlist(path, "AutoPay","AutoPay", "EnrollIntoAutopay_Business_CreditCard");
	}

	@Test(dataProvider="getLoginData")
	public void EnrollIntoAutopay_Business_CreditCard(Hashtable<String, String> tabledata) throws InterruptedException
	{

		logger=extent.startTest("EnrollIntoAutopay_Business_CreditCard","Enroll into autopay with credit card for Business customer");

		if(!(tabledata.get("Runmode").equals("Y") && tabledata.get("AutoPay").equals("Y")))
		{
			resultFlag="skip";
			logger.log(LogStatus.SKIP, "EnrollIntoAutopay_Business_CreditCard is Skipped");
	...
	public void afterMethod(){
		...
		if(resultFlag.equals("pass")){
			Excel.setCellValBasedOnTcname(path,"AutoPay","EnrollIntoAutopay_Business_CreditCard" , "Status", "Pass");

		}else if (resultFlag.equals("fail")){    
			Excel.setCellValBasedOnTcname(path,"AutoPay","EnrollIntoAutopay_Business_CreditCard" , "Status", "Fail");
		}else{
			Excel.setCellValBasedOnTcname(path, "AutoPay","EnrollIntoAutopay_Business_CreditCard" , "Status", "Skip");
		}
