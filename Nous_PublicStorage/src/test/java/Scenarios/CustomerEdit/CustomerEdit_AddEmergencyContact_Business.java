...
public class CustomerEdit_AddEmergencyContact_Business extends Browser_Factory {
	...
	public Object[][] getData() {
		return Excel.getCellValue_inlist(path, "CustomerEdit", "CustomerEdit","CustomerEdit_AddEmergencyContact_Business");
	}

	@Test(dataProvider = "getData")
	public void addEmergencyContact_Business(Hashtable<String, String> tabledata) throws InterruptedException {
