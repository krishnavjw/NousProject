...
public class CustomerEdit_Add_Delete_AuthorisedUser_Individual extends Browser_Factory {
	...
	public Object[][] getCustomerDtaData() {
		return Excel.getCellValue_inlist(path, "CustomerEdit", "CustomerEdit", "CustomerEdit_Add_Delete_AuthorisedUser_Individual");
	}

	@Test(dataProvider = "getCustomerDtaData")
	public void CustomerEdit_Add_Delete_AuthorisedUser_Individual(Hashtable<String, String> tabledata) throws InterruptedException {
		try {
			logger = extent.startTest("CustomerEdit_Add_Delete_AuthorisedUser_Individual", "CustomerEdit InsuranceUpdate starts ");
...
driver.get(Generic_Class.getPropertyValue("CustomerScreenPath_QA"));
			...
			String queryID =  "select top 1 aa.accountid from vw_unitdetails u "
					+ "join storageorderitemcontact soic with(nolock) on soic.storageorderitemid = u.storageorderitemid "
	...
	public void afterMethod() {
		...
		if (resultFlag.equals("pass")) {
			Excel.setCellValBasedOnTcname(path, "CustomerEdit", "CustomerEdit_Add_Delete_AuthorisedUser_Individual", "Status",
					"Pass");
