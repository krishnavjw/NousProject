...
public class CustomerEdit_AccountDetails_MergeAccount_Individual extends Browser_Factory {
	...
	public Object[][] getCustomerSearchData() {
		return Excel.getCellValue_inlist(path, "CustomerEdit", "CustomerEdit",
				"CustomerEdit_AccountDetails_MergeAccount_Individual");
	}

	@Test(dataProvider = "getCustomerSearchData")
	public void CustomerEdit_AccountDetails_MergeAccount_Individual(Hashtable<String, String> tabledata)
			throws Exception {
		if (!(tabledata.get("Runmode").equals("Y") && tabledata.get("CustomerEdit").equals("Y"))) {
			resultFlag = "skip";
			throw new SkipException("Skipping the CustomerEdit_AccountDetails_MergeAccount_Individual test");
		}
		...
		try {
			...
			logger = extent.startTest("CustomerEdit_AccountDetails_MergeAccount_Individual",
			...
			String query = "select top 1 A.CustomerId "
			...
			logger.log(LogStatus.INFO, "Entered  Account Number in Account field successfully "+accountNum);
	...
	public void afterMethod() {
		...
		if (resultFlag.equals("pass")) {
			Excel.setCellValBasedOnTcname(path, "CustomerEdit", "CustomerEdit_AccountDetails_MergeAccount_Individual",
					"Status", "Pass");
