...
public class CustomerEdit_InsuranceUpdate_Individual extends Browser_Factory {
	...
	public Object[][] getPaymentsData() {
		return Excel.getCellValue_inlist(path, "CustomerEdit", "CustomerEdit",
				"CustomerEdit_InsuranceUpdate_Individual");
	}

	@Test(dataProvider = "getPaymentsData")
	public void CustomerEdit_InsuranceUpdate_Individual(Hashtable<String, String> tabledata)
			throws InterruptedException {
		try {
			logger = extent.startTest("CustomerEdit_InsuranceUpdate_Individual",
					"CustomerEdit InsuranceUpdate starts ");
			...
			/*String sqlQuery = "Select Top 1 A.AccountNumber FROM AccountOrderItem AOI with(nolock)"
...
*/
	...
	public void afterMethod() {
		...
		if (resultFlag.equals("pass")) {
			Excel.setCellValBasedOnTcname(path, "CustomerEdit", "CustomerEdit_InsuranceUpdate_Individual", "Status",
					"Pass");
