...
public class CustomerEdit_UpdateEmergencyContact_Business extends Browser_Factory {
		 ...
		 //Getting data for Emergency contact  Before Update	
			...
			*/
			...
			try{
				...
				driver.findElement(By.xpath("//div/a[@class='psbutton-normal floatright']")).click();
				Thread.sleep(4000);
			...
			Thread.sleep(10000);
			logger.log(LogStatus.INFO, "Account Activities Tab");
