...
public class CustomerEdit_Individual_UpdateAddress extends Browser_Factory {
	...
	public Object[][] getCustomerEdit() {
		return Excel.getCellValue_inlist(path, "CustomerEdit", "CustomerEdit", "CustomerEdit_Individual_UpdateAddress");
	}

	@Test(dataProvider = "getCustomerEdit")
	public void CustomerEditIndividualAddress(Hashtable<String, String> tabledata) throws InterruptedException {
		...
		try {
			...
			logger = extent.startTest("CustomerEdit_Individual_UpdateAddress", "Customer Edit Individual - Address");
...
driver.get(Generic_Class.getPropertyValue("CustomerScreenPath_QA"));
			...
			try{
			if(driver.findElement(By.xpath("//span[text()='State']")).isDisplayed()){
...
List<WebElement> stateList = driver.findElements(By.xpath("//ul[@id='IndividualInformationModel_ContactIdentification_StateTypeID_listbox']/li"));
				...
				driver.findElement(By.xpath("//input[@id='IndividualInformationModel_ContactIdentification_EncryptedItem_EncryptedIdDisplay']")).clear();
				Thread.sleep(3000);
				driver.findElement(By.xpath("//input[@id='IndividualInformationModel_ContactIdentification_EncryptedItem_EncryptedIdDisplay']")).sendKeys("L1234569");	
			...
			if(driver.findElement(By.xpath("//div[@class=' js-state-drop-row']/div[@id='js-contactstate']")).isDisplayed()){
	...
	List<WebElement> stateList = driver.findElements(By.xpath("//ul[@id='Addresses_OfficialAddress_State_listbox']/li"));
				...
				driver.findElement(By.xpath("//input[@id='lesseeinfo-address-postalcode']")).clear();
				Thread.sleep(3000);
				driver.findElement(By.xpath("//input[@id='lesseeinfo-address-postalcode']")).sendKeys("54685");	
...
try{
	...
	public void afterMethod() {
		...
		if (resultFlag.equals("pass")) {
			Excel.setCellValBasedOnTcname(path, "CustomerEdit", "CustomerEdit_Individual_UpdateAddress", "Status",
					"Pass");
