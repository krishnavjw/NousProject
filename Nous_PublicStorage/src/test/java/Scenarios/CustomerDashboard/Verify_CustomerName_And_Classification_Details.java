...
public class Verify_CustomerName_And_Classification_Details extends Browser_Factory {
	...
	{
		return Excel.getCellValue_inlist(path,"CustomerDashBoard","CustomerDashBoard", "Verify_CustomerName_And_Classification_Details");
	}

	@Test(dataProvider="getLoginData")
	public void Verify_CustomerName_And_Classification_Details(Hashtable<String, String> tabledata) throws Exception 
	{
		...
		try{
			logger=extent.startTest("Verify_CustomerName_And_Classification_Details","Customer DashBoard - Verify Customer Name And Classification Details");
...
//=================Handling Customer Facing Device================================
	...
	public void afterMethod(){
		...
		if(resultFlag.equals("pass")){
			Excel.setCellValBasedOnTcname(path, "CustomerDashBoard","Verify_CustomerName_And_Classification_Details" , "Status", "Pass");

		}else if (resultFlag.equals("fail")){

			Excel.setCellValBasedOnTcname(path, "CustomerDashBoard","Verify_CustomerName_And_Classification_Details" , "Status", "Fail");
		}else{
			Excel.setCellValBasedOnTcname(path, "CustomerDashBoard","Verify_CustomerName_And_Classification_Details" , "Status", "Skip");
		}
