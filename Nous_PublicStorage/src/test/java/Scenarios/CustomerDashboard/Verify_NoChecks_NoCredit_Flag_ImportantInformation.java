...
public class Verify_NoChecks_NoCredit_Flag_ImportantInformation extends Browser_Factory {
	...
	{
		return Excel.getCellValue_inlist(path,"CustomerDashBoard","CustomerDashBoard", "Verify_NoChecks_NoCredit_Flag_ImportantInformation");
	}
	...
	public void Verify_NoChecks_NoCredit_Flag_ImportantInformation(Hashtable<String, String> tabledata) throws Exception 
	{
		...
		try{
			logger=extent.startTest("Verify_NoChecks_NoCredit_Flag_ImportantInformation","Customer DashBoard - Verify No Checks And No Credit Cards Flag in Important Information");
			...
			String updateQuery1="Update Customer SET NoChecks=0, NoCreditCards=0 WHERE customerid=(select customerid from account where AccountNumber='"+AccountNumber+"')";
			...
			String updateQueryde="UPDATE CUSTOMER SET NoChecks=1, NoCreditCards=0 where customerid=(select customerid from account where AccountNumber='"+AccountNumber+"')";
			DataBase_JDBC.executeSQLQuery(updateQueryde);
			logger.log(LogStatus.INFO, "No Checks Flag is updated in Database");
			Thread.sleep(5000);
			...
			if(cust_accdetails.verify_noChecks()){
				String scpath = Generic_Class.takeScreenShotPath();
				Reporter.log(scpath, true);
				String image = logger.addScreenCapture(scpath);
				logger.log(LogStatus.PASS, "No Checks flag is displayed successfully");
				logger.log(LogStatus.INFO, "No Checks flag is displayed successfully", image);
			}else{
				Thread.sleep(2000);
				String scpath = Generic_Class.takeScreenShotPath();
				Reporter.log(scpath, true);
				if(resultFlag.equals("pass"))
					resultFlag="fail";
				String image = logger.addScreenCapture(scpath);
				logger.log(LogStatus.FAIL, "No Checks Flag is not displayed");
				logger.log(LogStatus.INFO, "No Checks Flag is not displayed", image);
			}
			
			
			String updateQuery="UPDATE CUSTOMER SET NoChecks=0, NoCreditCards=1 where customerid=(select customerid from account where AccountNumber='"+AccountNumber+"')";
			DataBase_JDBC.executeSQLQuery(updateQuery);
			logger.log(LogStatus.INFO, "No Credit Cards Flag is updated in Database");
			Thread.sleep(5000);
			...
			if(cust_accdetails.verify_noCreditCard()){
				Thread.sleep(2000);
				String scpath = Generic_Class.takeScreenShotPath();
				Reporter.log(scpath, true);
				String image = logger.addScreenCapture(scpath);
				logger.log(LogStatus.PASS, "No Credit Cards Flag is displayed successfully");
				logger.log(LogStatus.INFO, "No Credit Cards Flag is displayed successfully", image);
			}
				...
				if(resultFlag.equals("pass"))
					resultFlag="fail";
				String image = logger.addScreenCapture(scpath);
				logger.log(LogStatus.FAIL, "No Credit Cards Flag is not displayed");
				logger.log(LogStatus.INFO, "No Credit Cards Flag is not displayed", image);
			}
			Thread.sleep(4000);
			
			String updateQueryee="UPDATE CUSTOMER SET NoChecks=1, NoCreditCards=1 where customerid=(select customerid from account where AccountNumber='"+AccountNumber+"')";
			DataBase_JDBC.executeSQLQuery(updateQueryee);
			logger.log(LogStatus.INFO, "No Credit Cards/ No Checks Flag is updated in Database");
			Thread.sleep(5000);
	...
	public void afterMethod(){
		...
		if(resultFlag.equals("pass")){
			Excel.setCellValBasedOnTcname(path, "CustomerDashBoard","Verify_NoChecks_NoCredit_Flag_ImportantInformation" , "Status", "Pass");

		}else if (resultFlag.equals("fail")){

			Excel.setCellValBasedOnTcname(path, "CustomerDashBoard","Verify_NoChecks_NoCredit_Flag_ImportantInformation" , "Status", "Fail");
		}else{
			Excel.setCellValBasedOnTcname(path, "CustomerDashBoard","Verify_NoChecks_NoCredit_Flag_ImportantInformation" , "Status", "Skip");
		}
