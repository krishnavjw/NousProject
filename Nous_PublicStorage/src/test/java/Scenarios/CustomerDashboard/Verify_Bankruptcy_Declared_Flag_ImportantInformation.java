...
public class Verify_Bankruptcy_Declared_Flag_ImportantInformation extends Browser_Factory {
	...
	{
		return Excel.getCellValue_inlist(path,"CustomerDashBoard","CustomerDashBoard", "Verify_Bankruptcy_Declared_Flag_ImportantInformation");
	}

	@Test(dataProvider="getLoginData")
	public void Verify_Bankruptcy_Declared_Flag_ImportantInformation(Hashtable<String, String> tabledata) throws Exception 
	{
		...
		try{
			logger=extent.startTest("Verify_Bankruptcy_Declared_Flag_ImportantInformation","Customer DashBoard - Verify Bankruptcy Declared in Important Information");
			...
			boolean bankruptcy = driver.findElements(By.xpath("//div[contains(text(),'Bankruptcy Declared')]")).size()>0;
			
			if(bankruptcy == false){
				String scpath = Generic_Class.takeScreenShotPath();
				Reporter.log(scpath, true);
				String image = logger.addScreenCapture(scpath);
				logger.log(LogStatus.PASS, "Bankruptcy Declared Flag is not displayed");
				logger.log(LogStatus.INFO, "Bankruptcy Declared Flag is not displayed", image);
			}else{
				Thread.sleep(2000);
				String scpath = Generic_Class.takeScreenShotPath();
				Reporter.log(scpath, true);
				if(resultFlag.equals("pass"))
					resultFlag="fail";
				String image = logger.addScreenCapture(scpath);
				logger.log(LogStatus.FAIL, "Bankruptcy Declared Flag is displayed");
				logger.log(LogStatus.INFO, "Bankruptcy Declared Flag is displayed", image);
			}
			
			String updateQuery2="UPDATE CUSTOMER SET IsBankrupt = 1 ,BankruptTypeId =853 , IsBankruptVerified = 0 where customerid=(select customerid from account where AccountNumber='"+AccountNumber+"')";
			DataBase_JDBC.executeSQLQuery(updateQuery2);
			logger.log(LogStatus.INFO, "Bankruptcy Declared Unverified Flag is updated in Database");
			Thread.sleep(5000);
			...
			((JavascriptExecutor)driver).executeScript("window.scrollTo(2000,0)");
			Thread.sleep(2000);
			if(cust_accdetails.verify_BankruptcyFlag())
			{
				logger.log(LogStatus.PASS, "Bankruptcy Declared Flag is displayed successfully");
			}else{
				logger.log(LogStatus.FAIL, "Bankruptcy Declared Flag is not displayed");
			}
			
			
			if(cust_accdetails.verify_BankruptcyUnverified()){
				String scpath = Generic_Class.takeScreenShotPath();
				Reporter.log(scpath, true);
				String image = logger.addScreenCapture(scpath);
				logger.log(LogStatus.PASS, "Bankruptcy Declared(unverified) flag is displayed successfully");
				logger.log(LogStatus.INFO, "Bankruptcy Declared(unverified) flag is displayed successfully", image);
			}else{
				Thread.sleep(2000);
				String scpath = Generic_Class.takeScreenShotPath();
				Reporter.log(scpath, true);
				if(resultFlag.equals("pass"))
					resultFlag="fail";
				String image = logger.addScreenCapture(scpath);
				logger.log(LogStatus.FAIL, "Bankruptcy Declared(unverified) Flag is not displayed");
				logger.log(LogStatus.INFO, "Bankruptcy Declared(unverified) Flag is not displayed", image);
			}
			
			
			String updateQuery="UPDATE CUSTOMER SET IsBankrupt = 1 ,BankruptTypeId =853 , IsBankruptVerified = 1 where customerid=(select customerid from account where AccountNumber='"+AccountNumber+"')";
			DataBase_JDBC.executeSQLQuery(updateQuery);
			logger.log(LogStatus.INFO, "Bankruptcy Declared Verified Flag is updated in Database");
			Thread.sleep(5000);
			...
			//verifying for Bankruptcy Declared verified flag
			
			((JavascriptExecutor)driver).executeScript("window.scrollTo(2000,0)");
			Thread.sleep(2000);
			
			if(cust_accdetails.verify_BankruptcyVerified()){
				Thread.sleep(2000);
				String scpath = Generic_Class.takeScreenShotPath();
				Reporter.log(scpath, true);
				String image = logger.addScreenCapture(scpath);
				logger.log(LogStatus.PASS, "Bankruptcy Declared verified flag is displayed successfully");
				logger.log(LogStatus.INFO, "Bankruptcy Declared verified flag is displayed successfully", image);
			}
				...
				if(resultFlag.equals("pass"))
					resultFlag="fail";
				String image = logger.addScreenCapture(scpath);
				logger.log(LogStatus.FAIL, "Bankruptcy Declared verified Flag is not displayed");
				logger.log(LogStatus.INFO, "Bankruptcy Declared verified Flag is not displayed", image);
			}
			Thread.sleep(4000);
	...
	public void afterMethod(){
		...
		if(resultFlag.equals("pass")){
			Excel.setCellValBasedOnTcname(path, "CustomerDashBoard","Verify_Bankruptcy_Declared_Flag_ImportantInformation" , "Status", "Pass");

		}else if (resultFlag.equals("fail")){

			Excel.setCellValBasedOnTcname(path, "CustomerDashBoard","Verify_Bankruptcy_Declared_Flag_ImportantInformation" , "Status", "Fail");
		}else{
			Excel.setCellValBasedOnTcname(path, "CustomerDashBoard","Verify_Bankruptcy_Declared_Flag_ImportantInformation" , "Status", "Skip");
		}
