...
public class StandaloneMerchandise_TransactionSystem_doesnotallowoverpayment_ExistingCustomer extends Browser_Factory {
	...
	{
		return Excel.getCellValue_inlist(path, "Merchandise","Merchandise","StandaloneMerchandise_TransactionSystem_doesnotallowoverpayment_ExistingCustomer");
	}
	...
	{
		try{
			logger=extent.startTest("StandaloneMerchandise_TransactionSystem_doesnotallowoverpayment_ExistingCustomer", "StandaloneMerchandise_TransactionSystem_doesnotallowoverpayment_ExistingCustomer");
...
String scpath1=Generic_Class.takeScreenShotPath();
	...
	public void afterMethod(){
		...
		if(resultFlag.equals("pass")){
			Excel.setCellValBasedOnTcname(path, "Merchandise","StandaloneMerchandise_TransactionSystem_doesnotallowoverpayment_ExistingCustomer" , "Status", "Pass");

		}else if (resultFlag.equals("fail")){

			Excel.setCellValBasedOnTcname(path, "Merchandise","StandaloneMerchandise_TransactionSystem_doesnotallowoverpayment_ExistingCustomer" , "Status", "Fail");
		}else{
			Excel.setCellValBasedOnTcname(path, "Merchandise","StandaloneMerchandise_TransactionSystem_doesnotallowoverpayment_ExistingCustomer" , "Status", "Skip");
		}
