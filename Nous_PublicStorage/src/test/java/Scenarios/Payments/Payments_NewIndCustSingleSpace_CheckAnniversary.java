...
public class Payments_NewIndCustSingleSpace_CheckAnniversary extends Browser_Factory {
	...
	public Object[][] getLoginData() {
		return Excel.getCellValue_inlist(path, "Payments", "Payments","Payments_NewIndCustSingleSpace_CheckAnniversary");
	}

	@Test(dataProvider = "getLoginData")
	public void Payments_NewIndCustSingleSpace_CheckAnniversary(Hashtable<String, String> tabledata) throws Exception {
		...
		try {
			...
			logger = extent.startTest("Payments_NewIndCustSingleSpace_CheckAnniversary","New individual customer make payment using Check anniversary pay");
	...
	public void afterMethod() {
		...
		if (resultFlag.equals("pass")) {
			Excel.setCellValBasedOnTcname(path, "Payments", "Payments_NewIndCustSingleSpace_CheckAnniversary", "Status","Pass");
		} else if (resultFlag.equals("fail")) {
			String scpath = Generic_Class.takeScreenShotPath();
			String image = logger.addScreenCapture(scpath);
			logger.log(LogStatus.FAIL, " page is not displayed", image);
			Excel.setCellValBasedOnTcname(path, "Payments", "Payments_NewIndCustSingleSpace_CheckAnniversary", "Status","Fail");
		} else {
			Excel.setCellValBasedOnTcname(path, "Payments", "Payments_NewIndCustSingleSpace_CheckAnniversary", "Status","Skip");
		}
