...
public class MakePaymentForCustomerInDTM extends Browser_Factory{
	...
	{
		return Excel.getCellValue_inlist(path, "Payments","Payments","MakePaymentForCustomerInDTM");
	}

	@Test(dataProvider="getCustSearchData")
	public void MakePaymentForCustomerInDTM(Hashtable<String, String> tabledata) throws InterruptedException 
	{
		try{
			logger=extent.startTest("MakePaymentForCustomerInDTM", "MakePayment_Business_NewCustomer_MultipleSpaces_paythroughCheck ");
	...
	public void afterMethod(){
		...
		if(resultFlag.equals("pass")){
			Excel.setCellValBasedOnTcname(path, "Payments","MakePaymentForCustomerInDTM" , "Status", "Pass");

		}else if (resultFlag.equals("fail")){

			Excel.setCellValBasedOnTcname(path, "Payments","MakePaymentForCustomerInDTM" , "Status", "Fail");
		}else{
			Excel.setCellValBasedOnTcname(path, "Payments","MakePaymentForCustomerInDTM" , "Status", "Skip");
		}
