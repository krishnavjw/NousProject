...
public class MakePayment_CustomerEditMerchandiseBeforePayment extends Browser_Factory {
	...
	{
		return Excel.getCellValue_inlist(path, "Payments","Payments", "MakePayment_CustomerEditMerchandiseBeforePayment");
	}
	

	@Test(dataProvider="getPurchasemerchandise")
	public void MakePayment_CustomerEditMerchandiseBeforePayment(Hashtable<String, String> tabledata) throws InterruptedException 
	{
		...
		try{
			...
			logger=extent.startTest("MakePayment_CustomerEditMerchandiseBeforePayment","Edit Merchandise with Payment");
			...
			//Edit or modify the Quantity and Click on Close button
			payments.clk_AddEditCart();
			logger.log(LogStatus.INFO, "Clicked on Add/Edit Cart Successfully");
			Thread.sleep(5000);
			merchandisePage.enter_Quantity("1");
			logger.log(LogStatus.INFO, "Entered Quantity in the textbox");
			Thread.sleep(5000);
			merchandisePage.clk_AddItemsToCart();
			logger.log(LogStatus.INFO, "Items are added in the cart");
	...
	public void afterMethod(){
		...
		if(resultFlag.equals("pass")){
			Excel.setCellValBasedOnTcname(path, "Payments","MakePayment_CustomerEditMerchandiseBeforePayment" , "Status", "Pass");

		}else if (resultFlag.equals("fail")){

			Excel.setCellValBasedOnTcname(path, "Payments","MakePayment_CustomerEditMerchandiseBeforePayment" , "Status", "Fail");
		}else{
			Excel.setCellValBasedOnTcname(path, "Payments","MakePayment_CustomerEditMerchandiseBeforePayment" , "Status", "Skip");
		}
