...
public class Payments_MultipleSpace_Anniversary extends Browser_Factory {
	...
	public Object[][] getPaymentsData() {
		return Excel.getCellValue_inlist(path, "Payments", "Payments", "Payments_MultipleSpace_Anniversary");
	}

	@Test(dataProvider = "getPaymentsData")
	public void Payments_MultipleSpace_Anniversary(Hashtable<String, String> tabledata) throws InterruptedException {
		...
		try {
			logger = extent.startTest("Payments_MultipleSpace_Anniversary", "Payments_MultipleSpace_Anniversary starts ");
			...
			payments.selectPaymentThroughForMultipleSpaces_Anniversary(12);
			Thread.sleep(3000);
			...
			driver.findElement(By.xpath("//div[text()='"+ Arr_Spaces[0]+"']/../../td[text()='Payment (Cash)']/../td[1]/a")).click();
	...
	public void afterMethod() {
		...
		if (resultFlag.equals("pass")) {
			Excel.setCellValBasedOnTcname(path, "Payments", "Payments_MultipleSpace_Anniversary", "Status", "Pass");

		} else if (resultFlag.equals("fail")) {

			Excel.setCellValBasedOnTcname(path, "Payments", "Payments_MultipleSpace_Anniversary", "Status", "Fail");
		} else {
			Excel.setCellValBasedOnTcname(path, "Payments", "Payments_MultipleSpace_Anniversary", "Status", "Skip");
		}
