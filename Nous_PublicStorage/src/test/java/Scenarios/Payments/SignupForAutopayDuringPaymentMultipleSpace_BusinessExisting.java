...
public class SignupForAutopayDuringPaymentMultipleSpace_BusinessExisting extends Browser_Factory {
	...
	{
		return Excel.getCellValue_inlist(path, "Payments","Payments", "SignupForAutopayDuringPaymentMultipleSpace_BusinessExisting");
	}


	@Test(dataProvider="getData")
	public void SignupForAutopayDuringPaymentMultipleSpace_BusinessExisting(Hashtable<String, String> tabledata) throws InterruptedException
	{
		logger=extent.startTest("SignupForAutopayDuringPaymentMultipleSpace_BusinessExisting","Signup For Autopay During Payment One Space");

		if(!(tabledata.get("Runmode").equals("Y") && tabledata.get("Payments").equals("Y")))
		{
			resultFlag="skip";
			logger.log(LogStatus.SKIP, "SignupForAutopayDuringPaymentMultipleSpace_BusinessExisting is Skipped");
	...
	public void afterMethod(){
		...
		if(resultFlag.equals("pass")){
			Excel.setCellValBasedOnTcname(path,"Payments","SignupForAutopayDuringPaymentMultipleSpace_BusinessExisting" , "Status", "Pass");

		}else if (resultFlag.equals("fail")){    
			Excel.setCellValBasedOnTcname(path,"Payments","SignupForAutopayDuringPaymentMultipleSpace_BusinessExisting" , "Status", "Fail");
		}else{
			Excel.setCellValBasedOnTcname(path, "Payments","SignupForAutopayDuringPaymentMultipleSpace_BusinessExisting" , "Status", "Skip");
		}
