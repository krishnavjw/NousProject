...
public class SignupForAutopayDuringPaymentOneSpace_IndividualExistingCust extends Browser_Factory {
	...
	{
		return Excel.getCellValue_inlist(path, "Payments","Payments", "SignupForAutopayDuringPaymentOneSpace_IndividualExistingCust");
	}


	@Test(dataProvider="getData")
	public void SignupForAutopayDuringPaymentOneSpace_IndividualExistingCust(Hashtable<String, String> tabledata) throws InterruptedException
	{
		logger=extent.startTest("SignupForAutopayDuringPaymentOneSpace_IndividualExistingCust","Signup For Autopay During Payment One Space");

		if(!(tabledata.get("Runmode").equals("Y") && tabledata.get("Payments").equals("Y")))
		{
			resultFlag="skip";
			logger.log(LogStatus.SKIP, "SignupForAutopayDuringPaymentOneSpace_IndividualExistingCust is Skipped");
	...
	public void afterMethod(){
		...
		if(resultFlag.equals("pass")){
			Excel.setCellValBasedOnTcname(path,"Payments","SignupForAutopayDuringPaymentOneSpace_IndividualExistingCust" , "Status", "Pass");

		}else if (resultFlag.equals("fail")){    
			Excel.setCellValBasedOnTcname(path,"Payments","SignupForAutopayDuringPaymentOneSpace_IndividualExistingCust" , "Status", "Fail");
		}else{
			Excel.setCellValBasedOnTcname(path, "Payments","SignupForAutopayDuringPaymentOneSpace_IndividualExistingCust" , "Status", "Skip");
		}
