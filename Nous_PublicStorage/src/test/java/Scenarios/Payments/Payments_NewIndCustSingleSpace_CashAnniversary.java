...
public class Payments_NewIndCustSingleSpace_CashAnniversary extends Browser_Factory {
	...
	public Object[][] getLoginData() {
		return Excel.getCellValue_inlist(path, "Payments", "Payments","Payments_NewIndCustSingleSpace_CashAnniversary");
	}

	@Test(dataProvider = "getLoginData")
	public void Payments_NewIndCustSingleSpace_CashAnniversary(Hashtable<String, String> tabledata) throws Exception {
		...
		try {
			...
			logger = extent.startTest("Payments_NewIndCustSingleSpace_CashAnniversary","New individual customer make payment using cash anniversary pay");
			...
			Thread.sleep(3000);
			driver.findElement(By.xpath("//div[div[div[div[text()='Lock Disc']]]]//input[@class='product-quantity webchamp-textbox']"))
			.sendKeys("1");
	...
	public void afterMethod() {
		...
		if (resultFlag.equals("pass")) {
			Excel.setCellValBasedOnTcname(path, "Payments", "Payments_NewIndCustSingleSpace_CashAnniversary", "Status","Pass");
		} else if (resultFlag.equals("fail")) {
			String scpath = Generic_Class.takeScreenShotPath();
			String image = logger.addScreenCapture(scpath);
			logger.log(LogStatus.FAIL, " page is not displayed", image);
			Excel.setCellValBasedOnTcname(path, "Payments", "Payments_NewIndCustSingleSpace_CashAnniversary", "Status","Fail");
		} else {
			Excel.setCellValBasedOnTcname(path, "Payments", "Payments_NewIndCustSingleSpace_CashAnniversary", "Status","Skip");
		}
