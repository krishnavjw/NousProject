...
public class Individual_AP_keepsource_channel_pricing_checked_Prepaid_customer_TCR extends Browser_Factory {
	...
	public void Individual_AP_keepsource_channel_pricing_checked_Prepaid_customer_TCR(Hashtable<String, String> tabledata) throws InterruptedException {
		try {

			logger = extent.startTest("Individual_AP_keepsource_channel_pricing_checked_Prepaid_customer_TCR",
					"Individual_AP_keepsource_channel_pricing_checked_Prepaid_customer_TCR ");
			...
			System.out.println(" th siteid_ipsdd_data is-----" + current_siteid);
				...
				logger=extent.startTest("Individual_AP_keepsource_channel_pricing_checked_Prepaid_customer_TCR", "Individual_AP_keepsource_channel_pricing_checked_Prepaid_customer_TCR ");
			...
			/*if(leaseQues.disableStorageContent()){
			...
			for (WebElement storage : allstorage) {
				...
				Reporter.log("Storage is disabled, so continuing!!");
			}*/
        ...
        Reporter.log("dfgsdfdfdfdfdfdfdfdfdfdfdfdfdfdfdfdfdfdfdfdfdfdfdfg", true); 
...
//        drawAction.perform();
//        Reporter.log("dsfsfsfsfsfsfsfsfsfsfsfsfsfsfsfsfsfsfsfsfsfsfsfsfsf", true);
//        Thread.sleep(5000);
//        driver.findElement(By.id("confirmButton")).click();
//        Thread.sleep(5000);
        //driver.findElement(By.cssSelector("body")).sendKeys(Keys.CONTROL,Keys.PAGE_DOWN);
