...
public class Individual_AP_Transfer_Customer_With_Balance_Due extends Browser_Factory {
	...
	public Object[][] getData() {
		return Excel.getCellValue_inlist(path, "TransferSpace", "TransferSpace",
				"Individual_AP_Transfer_Customer_With_Balance_Due");
	}

	@Test(dataProvider = "getData")
	public void Individual_AP_Transfer_Customer_With_Balance_Due(Hashtable<String, String> tabledata)
			throws InterruptedException {
		try {

			logger = extent.startTest("Individual_AP_Transfer_Customer_With_Balance_Due",
					"Individual_AP_Transfer_Customer_With_Balance_Due starts ");
	...
	public void afterMethod() {
		...
		if (resultFlag.equals("pass")) {
			Excel.setCellValBasedOnTcname(path, "Transfer", "Individual_AP_Transfer_Customer_With_Balance_Due",
					"Status", "Pass");
