...
public class Business_Anniversary_Transfer_On_SecondMonth_Of_MoveIn extends Browser_Factory {
	...
	public Object[][] getData() {
		return Excel.getCellValue_inlist(path, "TransferSpace", "TransferSpace",
				"Business_Anniversary_Transfer_On_SecondMonth_Of_MoveIn");
	}

	@Test(dataProvider = "getData")
	public void Business_Anniversary_Transfer_On_SecondMonth_Of_MoveIn(Hashtable<String, String> tabledata)
			throws InterruptedException {

		try {

			logger = extent.startTest("Business_Anniversary_Transfer_On_SecondMonth_Of_MoveIn",
					"Business_Anniversary_Transfer_On_SecondMonth_Of_MoveIn starts ");
			...
			String sqlQuery = "select aoip.promotionid, p.name, u.unitcost as MonthlyRent,aoipo.unitcost as Insurance,soi.rentdueday,soi.paymentmethodtypeid,u.* "
					...
					+ "where  u.moveindate > getdate()-60 and u.vacatedate is null and u.paidthrudate >getdate() "
	...
	public void afterMethod() {
		...
		if (resultFlag.equals("pass")) {
			Excel.setCellValBasedOnTcname(path, "Transfer", "Business_Anniversary_Transfer_On_SecondMonth_Of_MoveIn",
					"Status", "Pass");
