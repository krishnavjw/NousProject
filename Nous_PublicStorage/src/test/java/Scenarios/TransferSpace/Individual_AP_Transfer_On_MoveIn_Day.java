...
public class Individual_AP_Transfer_On_MoveIn_Day extends Browser_Factory {
	...
	public Object[][] getData() {
		return Excel.getCellValue_inlist(path, "TransferSpace", "TransferSpace",
				"Individual_AP_Transfer_On_MoveIn_Day");
	}

	@Test(dataProvider = "getData")
	public void Individual_AP_Transfer_On_MoveIn_Day(Hashtable<String, String> tabledata) throws InterruptedException {
		try {

			logger = extent.startTest("Individual_AP_Transfer_On_MoveIn_Day",
					"Individual_AP_Transfer_On_MoveIn_Day starts ");
			...
			String sqlQuery = "Select TOP 1 A.AccountNumber, s.siteid FROM AccountOrderItem AOI with(nolock) "
					...
					+ "where soi.moveindate= DATEADD(day, DATEDIFF(day, 0, GETDATE()), 0) "
					+ "and soi.vacatedate is null and soi.paymentmethodtypeid='101' "
					+ "and c.customertypeid='90' order by NEWID()";

			try {
				List<String> results = DataBase_JDBC.executeSQLQuery_List(sqlQuery);

				accountNumber = results.get(0);
			...
			/*
			 * transferspace.clk_viewDetails(); logger.log(LogStatus.INFO,
			 * "Clicked on View Details tab successfully");
			 * 
			 * transferspace.clk_viewDetailsCloseBtn();
			 * logger.log(LogStatus.INFO,
			 * "Clicked on Close Details tab successfully");
			 */
			...
			/*
			 * try { List<WebElement> removeButtons =
			 * driver.findElements(By.xpath("//a[text()='Remove']")); for (int i
			 * = 0; i < removeButtons.size() - 1; i++) {
			 * removeButtons.get(i).click(); Thread.sleep(500); } } catch
			 * (Exception e) { Reporter.log("No Extra Contacts are available!!!"
			 * ); }
			 */
			...
			driver.findElement(By.xpath("//span[@class='k-widget k-dropdown k-header js-military-branch']")).click();
			Thread.sleep(2000);
			...
			logger.log(LogStatus.INFO, "Validating Monthly rent and Promotions in Eligible Promotion Page");
			Thread.sleep(2000);

			String MonthlyRentDueNowAmount = payment.get_MonthlyRentDueNowAmt().substring(1).replace(",", "");
			logger.log(LogStatus.PASS,
			...
			String AdministrativeDueNowAmount = null;
			...
			String PayThroughDueNowAmount = null;
			...
			double Administrativeamt = 0.0;

			try {
				Administrativeamt = payment.getDoubleAmount(AdministrativeDueNowAmount);
			} catch (Exception e) {
				Reporter.log("Administrative fee is not valid for this transaction");
			}

			double Apythroughamt = 0.0;

			try {
				Apythroughamt = payment.getDoubleAmount(PayThroughDueNowAmount);
			} catch (Exception e) {
				Reporter.log("Administrative fee is not valid for this transaction");
			}
			...
			if (gateCodeAfterTransfer.equals(gateCodeAfterTransfer)) {
				...
				logger.log(LogStatus.INFO, "Gate Codes are equal Before & After Transfer of Spaces");
				logger.log(LogStatus.PASS, "Gate Codes are equal Before & After Transfer of Spaces", img1);
			} else {
				resultFlag = "fail";
				String scp = Generic_Class.takeScreenShotPath();
				String imag = logger.addScreenCapture(scp);
				logger.log(LogStatus.INFO, "Gate Codes are not equal Before & After Transfer of Spaces");
				logger.log(LogStatus.FAIL, "Gate Codes are not equal Before & After Transfer of Spaces", imag);
			}

			try {
				popup.clickOk_btn();
			} catch (Exception e) {
				Reporter.log("No Ok button is available, so Continuing!!!", true);
			}
			Thread.sleep(3000);
			...
			if (pmhomepage.isexistingCustomerModelDisplayed()) {
				String pa = Generic_Class.takeScreenShotPath();
				String img1 = logger.addScreenCapture(pa);
				logger.log(LogStatus.INFO, "PM DashBoard dispalyed sucessfully");
				logger.log(LogStatus.PASS, "PM DashBoard dispalyed sucessfully", img1);
			} else {
				...
				String scp = Generic_Class.takeScreenShotPath();
				String imag = logger.addScreenCapture(scp);
				logger.log(LogStatus.INFO, "PM DashBoard dispalyed  is not displayed");
				logger.log(LogStatus.FAIL, "PM DashBoard dispalyed  is not displayed", imag);
			}
			...
			if (cust.isCustdbTitleDisplayed()) {
				...
				logger.log(LogStatus.INFO, "customer Dashboard is displayed successfully");
				logger.log(LogStatus.PASS, "customer Dashboard is displayed successfully", mag);
			} else {
				...
				logger.log(LogStatus.INFO, "customer Dashboard is not displayed ");
				logger.log(LogStatus.FAIL, "customer Dashboard is not displayed ", mg);
			}
			...
			if (cust.getTotalDueNowTxt().contains("Total Due Now")) {
				...
				logger.log(LogStatus.INFO, "Total Due Now is displayed successfully" + cust.getCustDashboardTitle());
				...
				logger.log(LogStatus.INFO, "Total Due Now is not displayed successfully");
			...
			if (cust.getNextPaymentDueTxt().contains("Next Payment Due")) {
				...
				String img = logger.addScreenCapture(scp);
				logger.log(LogStatus.INFO, "Next Payment Due is displayed successfully" + cust.getCustDashboardTitle());
				...
				logger.log(LogStatus.INFO, "Next Payment Due is not displayed successfully");
			...
			if (cust.getMakePaymentTxt().contains("Make Payment")) {
				...
				String im = logger.addScreenCapture(sc);
				logger.log(LogStatus.INFO, "Make Payment is displayed successfully" + cust.getCustDashboardTitle());
				...
				String im = logger.addScreenCapture(sc);
				logger.log(LogStatus.INFO, "Make Payment is not displayed successfully");
			...
			if (cust.getManageAutoPayTxt().contains("Manage AutoPay")) {
				...
				logger.log(LogStatus.INFO, "Manage AutoPay is displayed successfully" + cust.getCustDashboardTitle());
				...
				String im = logger.addScreenCapture(st);
				logger.log(LogStatus.INFO, "Manage AutoPay is not displayed successfully");
			...
			if (cust.getCreateNoteTxt().contains("Create Note")) {
				...
				String im = logger.addScreenCapture(sc);
				logger.log(LogStatus.INFO, "Create Note is displayed successfully" + cust.getCustDashboardTitle());
				...
				String im = logger.addScreenCapture(sc);
				logger.log(LogStatus.INFO, "Create Note is not displayed successfully");
			...
			if (cust.getImportantInformationTxt().contains("Important Information")) {
				...
				logger.log(LogStatus.INFO, "Important Information is not displayed successfully");
			...
			if (cust.getCustomerInfoTabTxt().contains("Customer Info")) {
				...
				String ie = logger.addScreenCapture(sch);
				logger.log(LogStatus.INFO, "Customer Info tab displayed successfully" + cust.getCustomerInfoTabTxt());
				...
				logger.log(LogStatus.INFO, "Customer Info tab not  displayed successfully");
			...
			if (cust.getSpaceDetailsTabTxt().contains("Space Details")) {
				...
				String im = logger.addScreenCapture(scp);
				logger.log(LogStatus.INFO, " Space Details tab displayed successfully" + cust.getSpaceDetailsTabTxt());
				...
				logger.log(LogStatus.INFO, "Space Details tab not  displayed successfully");
			...
			if (cust.getAccountActivitiesTabTxt().contains("Account Activities")) {
				...
				String im = logger.addScreenCapture(sc);
				logger.log(LogStatus.INFO, "Account Activities tab not  displayed successfully");
			...
			if (cust.getDocumentsTabTxt().contains("Documents")) {
				...
				String im = logger.addScreenCapture(sc);
				logger.log(LogStatus.INFO, "  Documents tab displayed successfully" + cust.getDocumentsTabTxt());
				...
				String sc = Generic_Class.takeScreenShotPath();
				String im = logger.addScreenCapture(sc);
				logger.log(LogStatus.INFO, "Documents tab not  displayed successfully");
			...
			if (duepage.isPymtDueDetailsTitleDisplayed()) {
				...
				String sc = Generic_Class.takeScreenShotPath();
				String im = logger.addScreenCapture(sc);
				logger.log(LogStatus.INFO, "Payment Due Details page is displayed successfully");
				...
				String sc = Generic_Class.takeScreenShotPath();
				String im = logger.addScreenCapture(sc);
				logger.log(LogStatus.INFO, "Payment Due Details page is not displayed");
