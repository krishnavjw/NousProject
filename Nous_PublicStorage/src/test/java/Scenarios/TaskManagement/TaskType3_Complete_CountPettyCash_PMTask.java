...
public class TaskType3_Complete_CountPettyCash_PMTask extends Browser_Factory {
	...
	public Object[][] getLoginData() {
		return Excel.getCellValue_inlist(path, "TaskManagement", "TaskManagement", "TaskType3_Complete_CountPettyCash_PMTask");
	}

	@Test(dataProvider = "getLoginData")
	public void TaskType3_Complete_CountPettyCash_PMTask(Hashtable<String, String> tabledata) throws Exception {

		if (!(tabledata.get("Runmode").equals("Y") && tabledata.get("TaskManagement").equals("Y"))) {
			resultFlag = "skip";
			logger.log(LogStatus.SKIP, "TaskType3_Complete_CountPettyCash_PMTask is Skipped");
			throw new SkipException("Skipping the test ");
		}

		try {
			logger = extent.startTest("TaskType3_Complete_CountPettyCash_PMTask", "Task Type 3 - Complete CountPettyCash AMTask");
...
//=========================================================================================================
			...
			for (int i = 0; i < size1; i++) {
				...
				if (listTaskTitle1.get(i).getText().equals(TaskTitlefromDB)) {
					...
					logger.log(LogStatus.PASS, "Count Petty Cash Evening task displayed on Task List module ");
