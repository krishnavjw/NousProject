...
public class TaskType2_PM_To_Complete_The_Task extends Browser_Factory{
	...
	public void TaskType2_PM_To_Complete_The_Task(Hashtable<String, String> tabledata) throws Exception 
	{
		...
		/*	((JavascriptExecutor) driver).executeScript("window.scrollBy(0,3000)");
			...
			driver.findElement(By.xpath("//form[@id='viewTaskForm']/div[2]/div[1]/div/div[2]/div/label/span[1]")).click();
			logger.log(LogStatus.PASS, "Clicked on select all Checkbox ");
			Thread.sleep(2000);
