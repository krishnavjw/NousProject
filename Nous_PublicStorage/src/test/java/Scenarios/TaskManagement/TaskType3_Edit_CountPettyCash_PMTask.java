...
public class TaskType3_Edit_CountPettyCash_PMTask extends Browser_Factory {
	...
	public Object[][] getData() {
		return Excel.getCellValue_inlist(path, "TaskManagement", "TaskManagement", "TaskType3_Edit_CountPettyCash_PMTask");
	}
	...
	public void emailCompose(Hashtable<String, String> tabledata) throws Exception {
		...
		try {
					...
					/*	List<WebElement> listTask = driver.findElements(By.xpath("//table[@id='taskMasterList']/tbody/tr/td[4]"));
						int size=listTask.size();
						for(int i=0;i<size;i++){
							if(listTask.get(i).getText().contains("Count Petty Cash - Evening")){
								driver.findElement(By.xpath("//table[@id='taskMasterList']/tbody//tr//td[text()='Count Petty Cash - Evening']/following-sibling::td/a[text()='Edit']")).click();
								break;
							}
 							if(i%2==0){
						...
						*/
						...
						List<WebElement> taskNames=driver.findElements(By.xpath("//table[@id='taskMasterList']/tbody/tr/td[4]"));
						
						
						for(WebElement elem:taskNames)
						{
							act=new Actions(driver);
							act.moveToElement(elem).build().perform();
							
						 if(elem.getText().contains("Count Petty Cash - Evening"))
						 {
								js.executeScript("window.scrollBy(0,200)", "");
								Thread.sleep(4000);
							 
							 WebElement taskList = driver.findElement(By.xpath("//table[@id='taskMasterList']/tbody//tr//td[text()='Count Petty Cash - Evening']/following-sibling::td/a[text()='Edit']"));
							act.moveToElement(taskList).click().build().perform();
							break;			
						 }
                       ...
                       /*boolean isSelectedSuspendedRadioBtn = driver.findElement(By.xpath("//span[text()='Suspend']/preceding-sibling::span")).isSelected();
						...
						createTask.enterStartTime("03", "00");
						Thread.sleep(5000);
						
						driver.findElement(By.xpath("//span[text()='Before Close']/preceding-sibling::span")).click();
						
						
						logger.log(LogStatus.PASS, "Edit the start time as 3 PM");
						Thread.sleep(5000);
						...
						for(WebElement elem:taskNames1)
						{
						 ...
						 if(elem.getText().contains("Count Petty Cash - Evening"))
						 {
							 ...
							 WebElement taskList1 = driver.findElement(By.xpath("//table[@id='taskMasterList']/tbody//tr//td[text()='Count Petty Cash - Evening']/following-sibling::td/a[text()='Edit']"));
