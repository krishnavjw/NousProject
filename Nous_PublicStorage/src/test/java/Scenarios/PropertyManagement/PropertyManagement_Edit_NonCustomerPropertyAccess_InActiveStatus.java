...
public class PropertyManagement_Edit_NonCustomerPropertyAccess_InActiveStatus extends Browser_Factory{
	...
	{
		return Excel.getCellValue_inlist(path,"PropertyManagement","PropertyManagement",  "PropertyManagement_Edit_NonCustomerPropertyAccess_InActiveStaus");
	}
	...
	public void propertyManagement_Edit_NonCustomerPropertyAccess(Hashtable<String, String> tabledata) throws InterruptedException 
	{
		...
		try
		{
			...
			logger=extent.startTest("PropertyManagement_Edit_NonCustomerPropertyAccess_InActiveStaus","Property Management Edit noncustomer property access staus to inactive ");
		...
		if(((data.get(0)).equals(status1))){
			logger.log(LogStatus.PASS, "The non-customer status is changed to inactive ");
			System.out.println(status1);
		}
		else{
			logger.log(LogStatus.FAIL, "The non-customer status is not changed to inactive ");
			
		}
		
		}
		logger.log(LogStatus.INFO, "After changing, the  Status is : " +status1);	
	...
	public void afterMethod(){
		...
		if(resultFlag.equals("pass")){
			Excel.setCellValBasedOnTcname(path, "PropertyManagement","PropertyManagement_Edit_NonCustomerPropertyAccess_InActiveStaus" , "Status", "Pass");

		}else if (resultFlag.equals("fail")){

			Excel.setCellValBasedOnTcname(path, "PropertyManagement","PropertyManagement_Edit_NonCustomerPropertyAccess_InActiveStaus" , "Status", "Fail");
		}else{
			Excel.setCellValBasedOnTcname(path, "PropertyManagement","PropertyManagement_Edit_NonCustomerPropertyAccess_InActiveStaus" , "Status", "Skip");
		}
