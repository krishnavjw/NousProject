...
public class PropertyManagement_UpdateSpaceStatusForSpace_UnitVacate extends Browser_Factory{
	...
	public void propertyManagement_UpdateSpaceStatusForSpace_UnitVacate(Hashtable<String, String> tabledata) throws InterruptedException 
	{
		...
		try
		{
			...
			logger=extent.startTest(this.getClass().getSimpleName(),"Property Management - Update Space Status for Space - Unit Vacate");
			...
			String sqlQuery = "select top 1 ru.rentalunitnumber, ps.siteid from rentalunit ru with(nolock) "+
							  ...
							  " where ru.rentalstatustypeid=59 order by ps.siteid desc";
			...
			found = false;
			String[] expValuesNewStatus = {"Unit Occupied By Public Storage"};
			...
			found = false;
			String[] expValuesNewStatus2 = {"Unrentable Ops","Unit Occupied By Public Storage","Unrentable Construction/Dev","Unrentable Facilities Department"};
