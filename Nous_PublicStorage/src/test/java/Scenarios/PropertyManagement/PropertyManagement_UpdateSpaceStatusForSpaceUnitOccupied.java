...
public class PropertyManagement_UpdateSpaceStatusForSpaceUnitOccupied extends Browser_Factory {
	...
	{
		return Excel.getCellValue_inlist(path,"PropertyManagement","PropertyManagement",  "PropertyManagement_UpdateSpaceStatusForSpaceUnitOccupied");
	}



	@Test(dataProvider="getLoginData")
	public void PropertyManagement_UpdateSpaceStatusForSpaceUnitOccupied(Hashtable<String, String> tabledata) throws InterruptedException 
	{
		...
		try
		{
			...
			logger=extent.startTest("PropertyManagement_UpdateSpaceStatusForSpaceUnitOccupied","Property Management End of day processing ");
			testcaseName=tabledata.get("TestCases");
			Reporter.log("Test case started: " +testcaseName, true);

			String sqlQuery = "Select Top 1 ru.rentalunitnumber, s.siteid "+
					...
					" and ru.RentalStatusTypeID = '58' "+
					" group by ru.rentalunitnumber, s.siteid";
	...
	Bifrostpop.clickContiDevice();*/
			...
			if(driver.findElements(By.xpath("//div[@id='employeeNumberEntry']//div[text()='New Status:']/following-sibling::div//span[@class='k-input']")).size()!=0){
				scpath=Generic_Class.takeScreenShotPath();
				image=logger.addScreenCapture(scpath);
				logger.log(LogStatus.PASS, "New Status Dropdown is not displayed in Update Status for Space popup (DM User)");
				logger.log(LogStatus.INFO, "img",image);
				...
				scpath=Generic_Class.takeScreenShotPath();
				image=logger.addScreenCapture(scpath);
				logger.log(LogStatus.FAIL, "New Status Dropdown is displayed in Update Status for Space popup (DM User)");
				logger.log(LogStatus.INFO, "Image",image);
				if(resultFlag.equals("pass"))
					resultFlag="fail";
			}
	...
	Bifrostpop.clickContiDevice();*/
			...
			if(driver.findElements(By.xpath("//div[@id='employeeNumberEntry']//div[text()='New Status:']/following-sibling::div//span[@class='k-input']")).size()!=0){
				scpath=Generic_Class.takeScreenShotPath();
				image=logger.addScreenCapture(scpath);
				logger.log(LogStatus.PASS, "New Status Dropdown is not displayed in Update Status for Space popup (RM User)");
				logger.log(LogStatus.INFO, "img",image);
				...
				scpath=Generic_Class.takeScreenShotPath();
				image=logger.addScreenCapture(scpath);
				logger.log(LogStatus.FAIL, "New Status Dropdown is displayed in Update Status for Space popup (RM User)");
				logger.log(LogStatus.INFO, "Image",image);
				if(resultFlag.equals("pass"))
					resultFlag="fail";
			}
	...
	public void afterMethod(){
		...
		if(resultFlag.equals("pass")){
			Excel.setCellValBasedOnTcname(path, "PropertyManagement","PropertyManagement_UpdateSpaceStatusForSpaceUnitOccupied" , "Status", "Pass");

		}else if (resultFlag.equals("fail")){

			Excel.setCellValBasedOnTcname(path, "PropertyManagement","PropertyManagement_UpdateSpaceStatusForSpaceUnitOccupied" , "Status", "Fail");
		}else{
			Excel.setCellValBasedOnTcname(path, "PropertyManagement","PropertyManagement_UpdateSpaceStatusForSpaceUnitOccupied" , "Status", "Skip");
		}
