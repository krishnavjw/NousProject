...
public class PropertyManagement_UpdateSpaceStatusForSpace_PendingVacate extends Browser_Factory{
	...
	public void propertyManagement_UpdateSpaceStatusForSpace_PendingVacate(Hashtable<String, String> tabledata) throws InterruptedException 
	{
		...
		try
		{
			...
			logger=extent.startTest(this.getClass().getSimpleName(),"Property Management-Update Space Status for Space-Pending Vacate");
			...
			String sqlQuery = "select top 1 ru.rentalunitnumber, ps.siteid from rentalunit ru with(nolock) "+
					  ...
					  " where ru.rentalstatustypeid=2999 order by ps.siteid desc";
