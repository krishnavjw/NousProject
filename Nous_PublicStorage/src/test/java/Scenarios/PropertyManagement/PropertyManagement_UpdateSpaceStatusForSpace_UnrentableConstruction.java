...
public class PropertyManagement_UpdateSpaceStatusForSpace_UnrentableConstruction extends Browser_Factory{
	...
	public void propertyManagement_UpdateSpaceStatusForSpace_UnrentableConstruction(Hashtable<String, String> tabledata) throws InterruptedException 
	{
		...
		try
		{
			...
			logger=extent.startTest(this.getClass().getSimpleName(),"Property Management - Update Space Status for Space - Unrentable Construction");
			...
			String sqlQuery = "select top 1 ru.rentalunitnumber, ps.siteid from rentalunit ru with(nolock) "+
					...
					" where ru.rentalstatustypeid=6109 order by ps.siteid desc";
			...
			List<WebElement> newStatus = driver.findElements(By.xpath("//ul[@class='k-list k-reset ps-container ps-active-y']/li"));
			...
			found = false;
			String[] expValuesNewStatus = {"Unit Vacate","Unit Occupied By Public Storage"};
