...
public class DTM_Missed_Cal_reached extends Browser_Factory {
	...
	public void DTM_Missed_Cal_reached(Hashtable<String, String> tabledata) throws Exception {
		...
		try {
			...
			logger = extent.startTest("'DTM_Missed_Cal_reached", "'DTM_Missed_Cal_reached");
			...
			String newsiteid_missedcall = "select top 1 aoi.siteid from phonecall pc "+
					...
					"and t.name='Missed Commitment Call'";
		...
		//	dtmdashbrd.Collection_calls1(tabledata.get("Calltype"), driver);
			...
			WebElement callname=driver.findElement(By.xpath("//div[@class='collection-list']//div[@class='k-grid-content ps-container ps-active-y']/table/tbody/tr[3]/td[1]/a"));
			
			if(callname.isDisplayed()){
				
				logger.log(LogStatus.PASS, "The Missed Commitment Call is displayed");
			}else{
				
				resultFlag="fail";
				logger.log(LogStatus.FAIL, "Missed Commitment Call is not scheduled for the day");
			}
			Thread.sleep(2000);
			callname.click();
			Thread.sleep(6000);
