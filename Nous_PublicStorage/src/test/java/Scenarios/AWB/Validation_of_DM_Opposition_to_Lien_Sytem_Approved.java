...
public class Validation_of_DM_Opposition_to_Lien_Sytem_Approved extends Browser_Factory{
	...
	{
		return Excel.getCellValue_inlist(path, "AuctionWorkBench","AuctionWorkBench","Validation_of_DM_Opposition_to_Lien_Sytem_Approved");
	}

	@Test(dataProvider="getCustSearchData")
	public void Validation_of_DM_Opposition_to_Lien_Sytem_Approved(Hashtable<String, String> tabledata) throws InterruptedException 
	{
		try{
			logger=extent.startTest("Validation_of_DM_Opposition_to_Lien_Sytem_Approved", "Validation_of_DM_Opposition_to_Lien_Sytem_Approved");
	...
	public void afterMethod(){
		...
		if(resultFlag.equals("pass")){
			Excel.setCellValBasedOnTcname(path, "AuctionWorkBench","Validation_of_DM_Opposition_to_Lien_Sytem_Approved" , "Status", "Pass");

		}else if (resultFlag.equals("fail")){

			Excel.setCellValBasedOnTcname(path, "AuctionWorkBench","Validation_of_DM_Opposition_to_Lien_Sytem_Approved" , "Status", "Fail");
		}else{
			Excel.setCellValBasedOnTcname(path, "AuctionWorkBench","Validation_of_DM_Opposition_to_Lien_Sytem_Approved" , "Status", "Skip");
		}
