...
public class ExtendReservation_BusinessExistingCustomer extends Browser_Factory {
	...
	public void afterMethod() {
		...
		if (resultFlag.equals("pass")) {
			Excel.setCellValBasedOnTcname(path, "WalkinReservationLease", "ExtendReservation_BusinessExistingCustomer",
					"Status", "Pass");
	...
	public void ExtendReservation_BusinessExistingCustomer(Hashtable<String, String> tabledata) throws Exception {
		logger = extent.startTest("ExtendReservation_BusinessExistingCustomer",
				"Extend Reservation - Business Existing Customer");
		testcaseName = tabledata.get("TestCases");
		Reporter.log("Test case started: " + testcaseName, true);

		if (!(tabledata.get("Runmode").equals("Y") && tabledata.get("WalkinReservationLease").equals("Y"))) {
			resultFlag = "skip";
			logger.log(LogStatus.SKIP, "ExtendReservation_BusinessExistingCustomer is Skipped");
		...
		try {
			...
			// selecting Add space from Quick links Dropdown
	...
	public Object[][] getLoginData() {
		return Excel.getCellValue_inlist(path, "WalkinReservationLease", "WalkinReservationLease",
				"ExtendReservation_BusinessExistingCustomer");
	}
}
