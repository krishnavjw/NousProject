...
public class ExtendReservation_BusinessNewCustomer extends Browser_Factory {
	...
	public void afterMethod() {
		...
		if (resultFlag.equals("pass")) {
			Excel.setCellValBasedOnTcname(path, "WalkinReservationLease", "ExtendReservation_BusinessNewCustomer",
					"Status", "Pass");
	...
	public void ExtendReservation_BusinessNewCustomer(Hashtable<String, String> tabledata) throws Exception {
		logger = extent.startTest("ExtendReservation_BusinessNewCustomer", "WalkinReservationLease");
		testcaseName = tabledata.get("TestCases");
		Reporter.log("Test case started: " + testcaseName, true);

		if (!(tabledata.get("Runmode").equals("Y") && tabledata.get("WalkinReservationLease").equals("Y"))) {
			resultFlag = "skip";
			logger.log(LogStatus.SKIP, "ExtendReservation_BusinessNewCustomer is Skipped");
		...
		try {
			...
			// CreateReservation.btnMoveIndate());
			// Thread.sleep(5000);
			...
			String phoneNumber = viewReservationPage.getCustInfo_PhoneNumber().replaceAll("-", "");
			String emailId = viewReservationPage.getCustInfo_EmailId();
	...
	public Object[][] getLoginData() {
		return Excel.getCellValue_inlist(path, "WalkinReservationLease", "WalkinReservationLease",
				"ExtendReservation_BusinessNewCustomer");
	}
}
