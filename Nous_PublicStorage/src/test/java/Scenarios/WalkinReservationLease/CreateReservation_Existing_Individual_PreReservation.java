...
public class CreateReservation_Existing_Individual_PreReservation extends Browser_Factory {
	...
	public void afterMethod() {
		...
		if (resultFlag.equals("pass")) {
			Excel.setCellValBasedOnTcname(path, "WalkinReservationLease",
					"CreateReservation_Existing_Individual_PreReservation", "Status", "Pass");

		} else if (resultFlag.equals("fail")) {

			Excel.setCellValBasedOnTcname(path, "WalkinReservationLease",
					"CreateReservation_Existing_Individual_PreReservation", "Status", "Fail");
		} else {
			Excel.setCellValBasedOnTcname(path, "WalkinReservationLease",
					"CreateReservation_Existing_Individual_PreReservation", "Status", "Skip");
		}
	...
	public void CreateReservation_Existing_Individual_PreReservation(Hashtable<String, String> tabledata)
		...
		try {
			...
			logger = extent.startTest("CreateReservation_Existing_Individual_PreReservation",
			...
			String sqlQuery = "select Top 1 a.accountnumber  from account a "
					...
					+ "and soi.StorageOrderItemTypeID=4300 " + "and soi.anticipatedvacatedate is null "
	...
	public Object[][] getCustSearchData() {
		return Excel.getCellValue_inlist(path, "WalkinReservationLease", "WalkinReservationLease",
				"CreateReservation_Existing_Individual_PreReservation");
	}
}
