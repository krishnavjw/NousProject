...
public class CancelReservation_Individual_NewCustomer extends Browser_Factory {
	...
	public void afterMethod() {
		...
		if (resultFlag.equals("pass")) {
			Excel.setCellValBasedOnTcname(path, "WalkinReservationLease", "CancelReservation_Individual_NewCustomer",
					"Status", "Pass");
	...
	public void CancelReservation_Individual_NewCustomer(Hashtable<String, String> tabledata)
			throws InterruptedException {

		if (!(tabledata.get("Runmode").equals("Y") && tabledata.get("WalkinReservationLease").equals("Y"))) {
			resultFlag = "skip";
			logger.log(LogStatus.SKIP, "CancelReservation_Individual_NewCustomer is Skipped");
			throw new SkipException("Skipping the test");
		}
		try {

			logger = extent.startTest("CancelReservation_Individual_NewCustomer",
					"Customer walk in to reserve a space");
	...
	public Object[][] getLoginData() {
		...
		return Excel.getCellValue_inlist(path, "WalkinReservationLease", "WalkinReservationLease",
				"CancelReservation_Individual_NewCustomer");
	}
