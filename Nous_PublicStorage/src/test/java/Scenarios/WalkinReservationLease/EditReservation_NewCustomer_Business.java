...
public class EditReservation_NewCustomer_Business extends Browser_Factory {
	...
	public void afterMethod() {
		...
		if (resultFlag.equals("pass")) {
			Excel.setCellValBasedOnTcname(path, "WalkinReservationLease", "EditReservation_NewCustomer_Business",
					"Status", "Pass");
	...
	public Object[][] getCustSearchData() {
		return Excel.getCellValue_inlist(path, "WalkinReservationLease", "WalkinReservationLease",
				"EditReservation_NewCustomer_Business");
	}

	@Test(dataProvider = "getCustSearchData")
	public void reservation_newcustomer_Business(Hashtable<String, String> tabledata) throws InterruptedException {
		try {
			logger = extent.startTest("EditReservation_NewCustomer_Business",
					"Edit reservation of New customer-Business ");
			...
			String sqlQuery = "select top 1 reservationid from reservation "
					...
					+ "and reservationstatustypeid=127 order by reservationid desc";
