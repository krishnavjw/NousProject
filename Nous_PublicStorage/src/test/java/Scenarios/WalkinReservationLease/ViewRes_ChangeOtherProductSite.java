...
public class ViewRes_ChangeOtherProductSite extends Browser_Factory {
	...
	public void afterMethod() {
		...
		if (resultFlag.equals("pass")) {
			Excel.setCellValBasedOnTcname(path, "WalkinReservationLease", "ViewRes_ChangeOtherProductSite", "Status",
					"Pass");
	...
	public Object[][] getViewReservationData() {
		return Excel.getCellValue_inlist(path, "WalkinReservationLease", "WalkinReservationLease",
				"ViewRes_ChangeOtherProductSite");
	}

	@Test(dataProvider = "getViewReservationData")
	public void ViewReservationChangeOtherProductSite(Hashtable<String, String> tabledata) throws InterruptedException {
		...
		try {
			...
			logger = extent.startTest("ViewReservationChangeOtherProductSite",
					"View Reservation- Change Other Product Site");
