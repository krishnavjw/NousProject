...
public class CreateReservation_Existing_Individual extends Browser_Factory {
	...
	public void afterMethod() {
		...
		if (resultFlag.equals("pass")) {
			Excel.setCellValBasedOnTcname(path, "WalkinReservationLease", "CreateReservation_Existing_Individual",
					"Status", "Pass");
	...
	public Object[][] getCustSearchData() {
		return Excel.getCellValue_inlist(path, "WalkinReservationLease", "WalkinReservationLease",
				"CreateReservation_Existing_Individual");
	}

	@Test(dataProvider = "getCustSearchData")
	public void CreateReservation_Existing_Individual(Hashtable<String, String> tabledata) throws InterruptedException {
		...
		try {
			...
			logger = extent.startTest("CreateReservation_Existing_Individual",
