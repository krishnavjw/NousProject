...
public class EditReservation_ExistingCustomer_Individual extends Browser_Factory {
	...
	public void afterMethod() {
		...
		if (resultFlag.equals("pass")) {
			Excel.setCellValBasedOnTcname(path, "WalkinReservationLease", "EditReservation_ExistingCustomer_Individual",
					"Status", "Pass");
	...
	public Object[][] getCustSearchData() {
		return Excel.getCellValue_inlist(path, "WalkinReservationLease", "WalkinReservationLease",
				"EditReservation_ExistingCustomer_Individual");
	}
	...
	public void reservation_Existingcustomer_Individual(Hashtable<String, String> tabledata)
		...
		try {
			logger = extent.startTest("EditReservation_ExistingCustomer_Individual",
					"Edit reservation of Existing customer-Individual ");
