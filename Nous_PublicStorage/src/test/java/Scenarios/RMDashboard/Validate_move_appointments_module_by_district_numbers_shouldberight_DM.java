...
public class Validate_move_appointments_module_by_district_numbers_shouldberight_DM extends Browser_Factory{
	...
	{
		return Excel.getCellValue_inlist(path, "RMDashboard","RMDashboard","Validate_move_appointments_module_by_district_numbers_shouldberight_DM");
	}

	@Test(dataProvider="getCustSearchData")
	public void Validate_move_appointments_module_by_district_numbers_shouldberight_DM(Hashtable<String, String> tabledata) throws InterruptedException 
	{
		try{
			...
			rmhomepage.clk_appointemt_defaultdate();
			Thread.sleep(2000);	
			driver.findElement(By.xpath("//div[@id='move-in-appointments-filter-list']/ul/li[2]")).click();
			Thread.sleep(2000);	
