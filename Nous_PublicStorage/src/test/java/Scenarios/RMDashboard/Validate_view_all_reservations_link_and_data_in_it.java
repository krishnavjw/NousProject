...
public class Validate_view_all_reservations_link_and_data_in_it extends Browser_Factory{
	...
	{
		return Excel.getCellValue_inlist(path, "RMDashboard","RMDashboard","Validate_view_all_reservations_link_and_data_in_it");
	}

	@Test(dataProvider="getCustSearchData")
	public void Validate_view_all_reservations_link_and_data_in_it(Hashtable<String, String> tabledata) throws InterruptedException 
	{
		try{
			logger=extent.startTest("Validate_view_all_reservations_link_and_data_in_it", "Validate_view_all_reservations_link_and_data_in_it");
			...
			try{
				...
				logger.log(LogStatus.PASS, "Reservation Calls is displayed in RM DashBoard");
				logger.log(LogStatus.INFO, "Reservation Calls is displayed in RM DashBoard",image1);
				...
				if(resultFlag.equals("pass"))
					resultFlag="fail";
				logger.log(LogStatus.FAIL, "Reservation Calls is not displayed in RM DashBoard ");
				logger.log(LogStatus.INFO, "Reservation Calls is not displayed in RM DashBoard ",image);
			}
