...
public class Vacate_MisChrgespage {
   ...
   public void selectmischarges(String PaymentMethod,WebDriver driver) throws InterruptedException{
       click_SelectCharge();
           Thread.sleep(3000);
           List<WebElement> AllMischargeoptions = driver.findElements(By.xpath("//ul[contains(@class,'k-list k-reset ps-container ps-active-y')]/li[@class='k-item']"));
           Thread.sleep(2000);
           for(WebElement Alloptions:AllMischargeoptions){
                  if(Alloptions.getText().contains(PaymentMethod)){
                        Alloptions.click();
