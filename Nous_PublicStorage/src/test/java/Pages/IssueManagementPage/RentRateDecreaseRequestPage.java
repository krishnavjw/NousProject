...
public class RentRateDecreaseRequestPage {
	private WebDriver driver;
	
	
	@FindBy(xpath="//h3[contains(text(),'Create Rent Rate Decrease Request Issue')]")
	...
	public RentRateDecreaseRequestPage(WebDriver driver){
		this.driver=driver;
