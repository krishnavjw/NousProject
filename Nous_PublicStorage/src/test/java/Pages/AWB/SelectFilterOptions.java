...
public class SelectFilterOptions {
	...
	@FindBy(xpath="//button[@id='btn_ApplyFilters']")
	...
	public boolean isRmNotApprovedDisplayed(){

		return chkbx_rmNotApproved.isDisplayed();
	}
	...
	public boolean isnofilerdisplayed(){

		return chkbx_NoFilter.isDisplayed();
	}
	...
	public boolean isDmNotApprovedDisplayed(){
		return chkbx_dmNotApproved.isDisplayed();
	}


	public boolean isInventoryNotCompleteDisplayed(){

		return chkbx_InventoryNotComplete.isDisplayed();
	}
